...
samtools view -h -S -b -o $f.bam $f.sam
sambamba sort -o "$f"_s.bam $f.bam -t $p
sambamba view -h -t 2 -f bam -F "[XS] == null and not unmapped  and not duplicate" "$f"_s.bam > "$f"_d.bam
macs2 callpeak -t .bam -c .bam -f BAM -g mm -n $f 
```
