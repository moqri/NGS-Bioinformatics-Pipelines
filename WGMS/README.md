...
2. Formatting [ref](https://dnmtools.readthedocs.io/en/latest/format/)
...
### Calculating DNAm levels
   ...
   - ```$ dnmtools counts -c /path/to/genome.fa -o output.meth input.sam```
      ...
      - ```$ dnmtools counts -c /labs/vsebast/shared/wgms/hg38.fa -o d62_M38.meth d62_M38_val_mapped.bam```
      - ```reads in SAM file not sorted ```
